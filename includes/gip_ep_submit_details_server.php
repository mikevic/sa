...
require 'dbconnect.inc.php';
	...
	move_uploaded_file($_FILES["cv"]["tmp_name"], "../uploaded_files/gip-ep-cv/" . $cv_file_name);
	...
	header('Location: ../gip-ep-contract.php?no='.$contract_id['contract_id']);
?>
