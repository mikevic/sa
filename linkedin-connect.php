...
?>
	<div id="wrapper">
    	...
    	<div class="container">
          ...
          <h2 id="manage">LinkedIn Authorization:</h2>
          <?php
          if($_SESSION['oauth']['linkedin']['authorized'] === TRUE) {
            ...
            Your AIESEC South Africa Account has been synced with LinkedIn. We are grabbed the following bits of information from your LinkedIn account. If you update your information here (Change in Job etc), simply re-authenticate yourself here via linked in.
            
            <h2 id="profile">Your Profile:</h2>
            
            <?php
            $response = $OBJ_linkedin->profile('~:(id,first-name,last-name,picture-url,public-profile-url,headline)');
            if($response['success'] === TRUE) {
